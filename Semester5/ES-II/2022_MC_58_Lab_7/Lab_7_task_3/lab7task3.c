...
-----------------------------------------------------------------------
Task 7.3: Interface an external LED and a 10k Potentiometer with PWM
and analog pins of TIVA C Series LaunchPad, respectively. And program
it to control the brightness of the interfaced LED by varying potentiometer. 
-----------------------------------------------------------------------
...
void PWM_Module1_Channel6_Init(void){
	...
	PWM1->_3_CMPA = 2000;// 34605-2ms 36572-1ms
