...
-----------------------------------------------------------------------
Task 7.5 (Bonus Task): Interface a stepper motor with TIVA C Series
LaunchPad and program it to control it's speed by using potentiometer,
interfaced to any analog pin. Note: You will need multiple PWM signals
and external power supply for motor to work properly.
-----------------------------------------------------------------------
...
void PWM_Module1_Channel6_Init(void){
	...
	PWM1->_3_CMPA = 4000;// 34605-2ms 36572-1ms
